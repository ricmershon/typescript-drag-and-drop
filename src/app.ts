...
const projectState = ProjectState.getInstance();    // Global state
...
/**
 * Component base class. 'abstract' prevents the class from being instantiated
 * directly. Inheritance only.
 */
